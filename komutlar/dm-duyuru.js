...
exports.run = (client, message, args) => {
    ...
    if(!message.member.roles.has("Kullanacak rol id")) return message.channel.send(`Bu komutu kullanabilmek için \`Kullanacak rol adı\` yetkisine sahip olmasınız.`);
...
exports.help = {
  ...
  usage: 'duwuwdjfoexsxsxsjdhjmyurozanabi1numarau'
};