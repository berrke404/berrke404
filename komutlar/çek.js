...
if(!message.member.roles.has("Kullanacağı rol id")) return message.channel.send(`Bu komutu kullanabilmek için \`kullanacağı rol adı\` yetkisine sahip olmasınız.`);
...
exports.help = {
  name: 'çek',
  description: " ",
  usage: 'qweoewscscscscsqewqoewqoewqoqeowd'
}